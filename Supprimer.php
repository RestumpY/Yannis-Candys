	  ...
	  <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="Ajouter.php">Ajouter</a>
		      <a class="dropdown-item" href="Modifier.php?modif=bonbon" name="modifier">Modifier</a>
        </div>
    </li>
...
echo "
	...
	<div class='card mb-3 text-center' style='width: 15rem;'>
		...
		<div class='card-body'>
			...
			<a href='Supprimer2.php?suppr=<?php echo $produit->id ?>' onclick='return confirm("Etes vous sur de vouloir supprimer le bonbon <?php echo $produit->nom ?>");' class='btn btn-primary' name='supprimer' >Supprimer</a>
		</div>
	</div>
 <?php  
}
