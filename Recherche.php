...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><img src="Image/Icone.jpg" /></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	  ...
	  <li class="nav-item active">
        <a class="nav-link" href="Admin.php">Se connecter</a>
      </li>
    </ul>
    <form method="POST" action="" class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" placeholder="Rechercher" name="recherche" aria-label="Search">
      <button class="btn btn-outline-success my-2 my-sm-0" name="recherche" type="submit">Rechercher</button>
    </form>
  </div>
</nav>
...
$recherche =securiser(strtoupper($_POST["recherche"])); // Fonction securiser.
...
<a href='Index.php' class='btn btn-primary btn-lg btn-block'>Retour au menu</a>
