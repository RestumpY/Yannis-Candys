...
<form method="POST" action="Ajouter2.php" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="nom" aria-describedby="emailHelp" placeholder="Nom du bonbon">
  </div>
  <div class="form-group">
    <label for="exampleInput">Prix du produit</label>
    <input type="text" class="form-control" id="exampleInput" name="prix" placeholder="Prix du bonbon">
	<br> <br>
